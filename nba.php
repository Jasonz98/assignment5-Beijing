...
<figure class="photo-frame">
     <img src="images/nba.png" alt="NBA" height = "300" width = "300">
     <figcaption>The logo, Jerry West.</figcaption>
   </figure>
 </div>
 </section>
...
<figure class="photo-frame">
     ...
     <img src="images/westbrook.jpg" alt="Russ" height = "300" width = "300">
     <figcaption>Westbrook stat hoarding in the regular season.</figcaption>
   </figure>
 </div>
